...
function bindStaticEvents(){
  ...
  $('heroPickerClose').addEventListener('click',()=>$('heroPickerDialog').close());$('heroPickerDialog').addEventListener('click',event=>{if(event.target===$('heroPickerDialog'))$('heroPickerDialog').close()});$('starterClose').addEventListener('click',()=>$('starterDialog').close());$('starterDialog').addEventListener('click',event=>{if(event.target===$('starterDialog'))$('starterDialog').close()});
