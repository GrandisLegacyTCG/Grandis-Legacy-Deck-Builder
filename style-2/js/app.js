...
function legacyReferenceCardHtml(card){return `<article class="library-card legacy-reference-tile" title="${esc(card.name)}"><img src="${card.image}" alt="${esc(card.name)}">${reviewButton(card.id)}</article>`}
