...
const js=fs.readFileSync('style-2/js/app-v1.17.js','utf8');
const css=fs.readFileSync('style-2/css/app-v1.17.css','utf8');
const html=fs.readFileSync('style-2/index.html','utf8');

// Active v1.17 assets and Main Deck view control.
assert(html.includes('app-v1.17.js?v=1.17'),'v1.17 JavaScript asset is not active');
assert(html.includes('app-v1.17.css?v=1.17'),'v1.17 CSS asset is not active');
...
console.log('PASS Deck Builder v1.17 Style 2 minor mobile alignment and Main Deck view contracts');
