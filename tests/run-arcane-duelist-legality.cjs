...
const data=JSON.parse(fs.readFileSync(path.join(root,"data/season1/cards.runtime.v0.12.5.json"),"utf8"));
...
const context={window:{},globalThis:{}};context.window=context;context.globalThis=context;vm.createContext(context);vm.runInContext(fs.readFileSync(path.join(root,"public/js/runtime-authority.js"),"utf8"),context);
