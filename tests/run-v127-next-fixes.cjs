...
const s1=fs.readFileSync(path.join(root,'js/app.js'),'utf8'),s2=fs.readFileSync(path.join(root,'style-2/js/app-v1.31.js'),'utf8'),css=fs.readFileSync(path.join(root,'style-2/css/app-v1.31.css'),'utf8'),pkg=require(path.join(root,'package.json'));
must(pkg.version==='1.31.0','package version');
