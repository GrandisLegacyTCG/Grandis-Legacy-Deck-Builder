...
const style2=fs.readFileSync('style-2/js/app-v1.19.js','utf8');
...
must(pkg.version==='1.21.0','Package version must be 1.20.0');
...
must(style2Html.includes('js/app-v1.19.js')&&style2Html.includes('css/app-v1.19.css'),'Style 2 v1.19 runtime refs missing');
