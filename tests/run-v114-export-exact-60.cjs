...
const style2=fs.readFileSync('style-2/js/app-v1.18.js','utf8');
const style2Html=fs.readFileSync('style-2/index.html','utf8');
const style2Css=fs.readFileSync('style-2/css/app-v1.18.css','utf8');
function must(x,m){if(!x)throw new Error(m)}
must(pkg.version==='1.18.0','Package version must be 1.18.0');
...
must(style2Html.includes('js/app-v1.18.js')&&style2Html.includes('css/app-v1.18.css'),'Style 2 v1.18 runtime refs missing');
...
console.log('PASS Deck Builder v1.18 preserves exact-60 export contract for Style 1 + Style 2');
