...
function showHover(cardId,anchor){
  ...
  const rect=anchor.getBoundingClientRect(),deckPanel=anchor.closest('.deck-shell')?.getBoundingClientRect(),previewRect=box.getBoundingClientRect(),width=previewRect.width||250,height=previewRect.height||350;
  const desiredCenterX=deckPanel?deckPanel.left:rect.left;
  let x=desiredCenterX-width/2-6,y=rect.top+(rect.height-height)/2;
