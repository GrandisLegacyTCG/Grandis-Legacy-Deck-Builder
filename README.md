...
- **Style 2** — v2.10 at `/style-2/`: `https://grandislegacytcg.github.io/Grandis-Legacy-Deck-Builder/style-2/`
...
- Style 2 uses a **LEGACY DECK LIBRARY** button beside the `0 / 12` Legacy Deck total.
- The display-only library shows Heroes first, then Legacies, with Main Deck Card Library-sized cards and no search/filter/dimming.
