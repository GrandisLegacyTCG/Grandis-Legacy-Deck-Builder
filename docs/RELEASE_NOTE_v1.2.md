...
- Removes search/filter controls and dimming from this reference library.
- Makes popup cards use the same readable scale as the Main Deck Card Library.
- Deck format, Legacy selection behavior, card definitions, starter data, and gameplay rules are unchanged.
